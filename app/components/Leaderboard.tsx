  ...
  return (
    <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-5 shadow-xl">
      <div className="text-center mb-4">
        <h3 className="text-xl font-bold">{gameLabels[gameType]}</h3>
        <p className="text-xs text-gray-500">Pemain dengan bintang terbanyak</p>
      </div>
        ...
        {rankings.map((rank, i) => (
          <div
            ...
            className={`flex items-center justify-between p-3 rounded-xl transition ${
              i === 0 ? 'bg-yellow-100 border border-yellow-400' :
      ...
      <button
        onClick={fetchRankings}
        className="w-full mt-4 bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 rounded-xl text-sm font-semibold transition flex items-center justify-center gap-2"
      >
        🔄 Refresh Leaderboard
      </button>
